...
{
    public sealed class UpdateCurrentPlayerProfileCommandHandlerTests
    {
        [Fact]
        public async Task Handle_ShouldUpdateCurrentPlayerProfileAndSaveChanges_WhenProfileExists()
        {
            ...
            var handler = new UpdateCurrentPlayerProfileCommandHandler(
